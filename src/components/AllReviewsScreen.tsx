    ...
    <div className="h-full flex flex-col relative overflow-hidden" style={{ backgroundColor: 'var(--background)' }}>
      ...
      <div className="px-6 py-4 glass relative z-10" style={{ borderBottom: '1px solid rgba(46, 122, 217, 0.1)' }}>
        <div className="flex items-center gap-4">
          ...
          <h3 className="font-semibold" style={{ color: 'var(--foreground)' }}>Reviews ({service?.reviews || 234})</h3>
        </div>
      </div>

      {/* Rating Summary */}
      <div className="px-6 py-6 relative z-10 animate-fade-in-up">
        <div
      ...
      {/* Sort Filter */}
      <div className="px-6 py-2 relative z-10 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
        <select
