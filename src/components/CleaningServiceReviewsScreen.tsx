...
interface CleaningServiceReviewsScreenProps {
  serviceName: string;
...
const allReviews: Review[] = [
  ...
  },
  {
    ...
    userName: 'Emily K.',
    rating: 5,
    comment: 'Outstanding work! They paid attention to every detail and were very respectful of my home.',
    date: '3 weeks ago',
    imageCount: 3
  },
  {
    ...
    userName: 'David L.',
    rating: 5,
    comment: 'Best cleaning service I have ever used. Professional, efficient, and friendly.',
    date: '1 month ago'
  },
  {
    id: '6',
  ...
  },
  {
    ...
    userName: 'Amanda P.',
    rating: 5,
    comment: 'Incredible attention to detail. They cleaned areas I didn\'t even think about.',
    date: '2 months ago'
  },
  {
    id: '9',
  ...
  },
  {
    ...
    userName: 'Lisa H.',
    rating: 5,
    comment: 'Absolutely perfect! My office has never been cleaner. Thank you!',
    date: '2 months ago',
    imageCount: 1
  }
];

export function CleaningServiceReviewsScreen({
  serviceName,
  overallRating,
  totalReviews,
  onBack
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-3">
                  <img src={profilePhoto} alt={review.userName} className="w-10 h-10 rounded-full object-cover shadow-premium-sm" />
