          ...
          <div className="mb-4">
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span className="text-gray-600">Professional tools and equipment</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-gray-700 mt-1">✓</span>
                <span className="text-gray-600">Experienced and licensed professionals</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-gray-700 mt-1">✓</span>
                <span className="text-gray-600">Quality workmanship guarantee</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-gray-700 mt-1">✓</span>
                <span className="text-gray-600">Clean-up after job completion</span>
              </li>
            </ul>
          </div>
